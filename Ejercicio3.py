...
print("Total Mujeres: ", op1, " equivaliendo a un porcentaje de",(op1/(op1+op2))*100, "% del total")
print("Total Hombres: ", op2, " equivaliendo a un porcentaje de",(op2/(op1+op2))*100, "% del total")
